<template>
  ...
  <div class="sean-smooth-wrapper actors-wrap">
    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/sean-bean.jpg">
      <img src="/images/img-1000/sean-bean(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="sean-smooth-content actors-section">

      <div class="sean-blog actors-blog">
        <h1 class="actors-h1">Sean<br/>Bean</h1>
      ...
      <div class="sean-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item actors">
            <img src="/sean-bean-movies/equilibrium.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/sean-bean-movies/lord-of-the-rings.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/sean-bean-movies/martian.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/sean-bean-movies/medici.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/sean-bean-movies/national-treasure.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/sean-bean-movies/sharpe.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/sean-bean-movies/troy.jpg" alt="" class="slider-img last">
          </div>
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.sean-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.sean-smooth-content');
  const $blog = document.querySelector('.sean-blog');
  const $actorsSlider = document.querySelector('.sean-slider');
