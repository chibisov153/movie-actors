<template>
  ...
  <div class="nikolai-smooth-wrapper actors-wrap">
    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/nikolai-coster-waldau.jpg">
      <img src="/images/img-1000/nikolai-coster-waldau(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="nikolai-smooth-content actors-section">

      <div class="nikolai-blog actors-blog">
        <h1 class="actors-h1">Nikolai<br/>Coster-Waldau</h1>
      ...
      <div class="nikolai-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item actors">
            <img src="/nikolai-coster-waldau-movies/against-the-lce.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/nikolai-coster-waldau-movies/en-chance-til.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/nikolai-coster-waldau-movies/gods-of-egypt.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/nikolai-coster-waldau-movies/hodejegerne.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/nikolai-coster-waldau-movies/new-amsterdam.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/nikolai-coster-waldau-movies/shot-caller.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/nikolai-coster-waldau-movies/the-silencing.jpg" alt="" class="slider-img last">
          </div>
...
import {moveSliderRight, moveSliderLeft, sliderStart,
  observerSlider, useSlider} from "~/composables/slider";
import {
  actorFromEnterFalse,
  actorFromEnterTrue,
  actorEnterFalse,
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.nikolai-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.nikolai-smooth-content');
  const $blog = document.querySelector('.nikolai-blog');
  const $actorsSlider = document.querySelector('.nikolai-slider');
