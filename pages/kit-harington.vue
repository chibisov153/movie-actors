<template>
  <div class="kit-smooth-wrapper actors-wrap">

    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/kit-harington.jpg">
      <img src="/images/img-1000/kit-harington(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="kit-smooth-content actors-section">
      <div class="kit-blog actors-blog">
        <h1 class="actors-h1">Kit<br/>Harington</h1>
      ...
      <div class="kit-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item kit">
            <img src="/kit-harington-movies/Better-fate.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/kit-harington-movies/brimstone.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/kit-harington-movies/gunpowder.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/kit-harington-movies/John-F-Donovan.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/kit-harington-movies/pompeii.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/kit-harington-movies/Seventh-Son.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/kit-harington-movies/Silent-Hill.jpg" alt="" class="slider-img last">
          </div>
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.kit-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.kit-smooth-content');
  const $blog = document.querySelector('.kit-blog');
  const $actorsSlider = document.querySelector('.kit-slider');
