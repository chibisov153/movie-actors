<template>
  ...
  <div class="pater-smooth-wrapper actors-wrap">
    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/peter-dinklage.jpg">
      <img src="/images/img-1000/peter-dinklage(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="pater-smooth-content actors-section">

      <div class="pater-blog actors-blog">
        <h1 class="actors-h1">Pater<br/>Dinklage</h1>
      ...
      <div class="pater-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item actors">
            <img src="/pater-dinklage-movies/death-funeral.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/pater-dinklage-movies/i-care-a-lot.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/pater-dinklage-movies/living-in-oblivion.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/pater-dinklage-movies/narnia.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/pater-dinklage-movies/station-agent.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/pater-dinklage-movies/three-billboards.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/pater-dinklage-movies/threshold.jpg" alt="" class="slider-img last">
          </div>
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.pater-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.pater-smooth-content');
  const $blog = document.querySelector('.pater-blog');
  const $actorsSlider = document.querySelector('.pater-slider');
