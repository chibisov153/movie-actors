<template>
  ...
  <div class="emilia-smooth-wrapper actors-wrap">
    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/emilia-clarke.jpg">
      <img src="/images/img-1000/emilia-clarke(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="emilia-smooth-content actors-section">

      <div class="emilia-blog actors-blog">
        <h1 class="actors-h1">Emilia<br/>Clarke</h1>
      ...
      <div class="emilia-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item actors">
            <img src="/emilia-clarke-movies/Above-Suspicion.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/emilia-clarke-movies/Voice-from-the-stone.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/emilia-clarke-movies/Last-Christmas.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/emilia-clarke-movies/Me-Before-You.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/emilia-clarke-movies/solo.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/emilia-clarke-movies/Spike-Island.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/emilia-clarke-movies/Dom-Hemingway.jpg" alt="" class="slider-img last">
          </div>
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.emilia-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.emilia-smooth-content');
  const $blog = document.querySelector('.emilia-blog');
  const $actorsSlider = document.querySelector('.emilia-slider');
