<template>
  ...
  <div class="natalie-smooth-wrapper actors-wrap">
    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/natalie-dormer.jpg">
      <img src="/images/img-1000/natalie-dormer(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="natalie-smooth-content actors-section">

      <div class="natalie-blog actors-blog">
        <h1 class="actors-h1">Natalie<br/>Dormer</h1>
      ...
      <div class="natalie-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item actors">
            <img src="/natalie-dormer-movies/darkness.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/natalie-dormer-movies/hunger-games.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/natalie-dormer-movies/penny-dreadful.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/natalie-dormer-movies/picnic-hanging-rock.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/natalie-dormer-movies/rush.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/natalie-dormer-movies/scandalous-lady.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/natalie-dormer-movies/tudors.jpg" alt="" class="slider-img last">
          </div>
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.natalie-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.natalie-smooth-content');
  const $blog = document.querySelector('.natalie-blog');
  const $actorsSlider = document.querySelector('.natalie-slider');
