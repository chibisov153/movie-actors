<template>
  ...
  <div class="lena-smooth-wrapper actors-wrap">
    <picture class="actors-container">
      <source media="screen and (min-width: 992px)" srcset="/images/lena-headey.jpg">
      <img src="/images/img-1000/lena-headey(1000).jpg" class="actors-img" alt="">
    </picture>

    <NuxtLink to="/" class="actors-link">
      <img src="/images/logo-Targaryen.png" alt="">
    </NuxtLink>
    <div class="lena-smooth-content actors-section">

      <div class="lena-blog actors-blog">
        <h1 class="actors-h1">Lena<br/>Headey</h1>
      ...
      <div class="lena-slider actors-slider">
        ...
        <div class="slider-wrap">
          <div class="slider-item actors">
            <img src="/lena-headey-movies/aberdeen.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/lena-headey-movies/broken.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/lena-headey-movies/gossip.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/lena-headey-movies/jungle-book.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/lena-headey-movies/man-with-rain.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/lena-headey-movies/merlin.jpg" alt="" class="slider-img">
          </div>
          <div class="slider-item">
            <img src="/lena-headey-movies/onegin.jpg" alt="" class="slider-img last">
          </div>
...
onMounted(() => {
  ...
  const $actorsSmoothWrap = document.querySelector('.lena-smooth-wrapper');
  const $actorsSmoothContent = document.querySelector('.lena-smooth-content');
  const $blog = document.querySelector('.lena-blog');
  const $actorsSlider = document.querySelector('.lena-slider');
